--[[
	...
	Updated by Sylvie for Duskhaven - 2023								   
...
------------------------------------------------------------------------------------
--
-- CensusPlus Duskhaven
-- A WoW UI customization by Cooper Sellers
-- Updated for Turtle WoW by Sylvie
--
--
------------------------------------------------------------------------------------
...
--
---------------------------------------------------------------------------------
local CensusPlus_VERSION = "4.3.0"; 			-- version
...
function CensusPlus_Msg(msg)
	...
	ChatFrame1:AddMessage("Census+ Duskhaven: "..msg, 1.0, 1.0, 0.5);
end
...
function CensusPlus_WhoMsg(msg)
	...
	ChatFrame1:AddMessage("Census+ Duskhaven Who: "..msg, 0.8, 0.8, 0.1);
end
...
local function CensusPlus_Msg2( msg )
	...
	ChatFrame2:AddMessage("Census+ Duskhaven: "..msg, 0.5, 1.0, 1.0);
end
...
local CENSUSPlus_DUSKHAVEN         = "Duskhaven";


local g_FactionCheck = {};
g_FactionCheck[CENSUSPlus_ORC]		= CENSUSPlus_DUSKHAVEN;
g_FactionCheck[CENSUSPlus_TAUREN]	= CENSUSPlus_DUSKHAVEN;
g_FactionCheck[CENSUSPlus_TROLL]	= CENSUSPlus_DUSKHAVEN;
g_FactionCheck[CENSUSPlus_UNDEAD]	= CENSUSPlus_DUSKHAVEN;
g_FactionCheck[CENSUSPlus_BLOODELF]	= CENSUSPlus_DUSKHAVEN;

g_FactionCheck[CENSUSPlus_DWARF]	= CENSUSPlus_DUSKHAVEN;
g_FactionCheck[CENSUSPlus_GNOME]	= CENSUSPlus_DUSKHAVEN;
g_FactionCheck[CENSUSPlus_HUMAN]	= CENSUSPlus_DUSKHAVEN;
g_FactionCheck[CENSUSPlus_NIGHTELF]	= CENSUSPlus_DUSKHAVEN;
g_FactionCheck[CENSUSPlus_DRAENEI]	= CENSUSPlus_DUSKHAVEN;
...
function CensusPlus_GetFactionRaces(faction)
	local ret = {};
	ret = {CENSUSPlus_DWARF, CENSUSPlus_GNOME, CENSUSPlus_HUMAN, CENSUSPlus_NIGHTELF, CENSUSPlus_DRAENEI, CENSUSPlus_ORC, CENSUSPlus_TAUREN, CENSUSPlus_TROLL, CENSUSPlus_UNDEAD, CENSUSPlus_BLOODELF};
	return ret;
end
...
local function GetRaceClasses(race)
	...
	elseif (race == CENSUSPlus_NIGHTELF) then
		ret = {CENSUSPlus_WARRIOR, CENSUSPlus_HUNTER, CENSUSPlus_ROGUE, CENSUSPlus_PRIEST, CENSUSPlus_MAGE, CENSUSPlus_DRUID, CENSUSPlus_DEATHKNIGHT};
...
function CensusPlus_OnLoad()
	...
	--
	CensusPlusText:SetText("Census+ Duskhaven v"..CensusPlus_VERSION .. " " .. g_CensusPlusLocale );
...
--		InsertJobIntoQueue(job);
        ...
        local job = CensusPlus_CreateJob( 51, 59, nil, nil, nil );
        InsertJobIntoQueue(job);
        
		job = CensusPlus_CreateJob( 60, 60, nil, nil, nil );
		InsertJobIntoQueue(job);
...
function CensusPlus_ProcessTarget( unit )
	...
	if (sightingData ~= nil and (sightingData.faction == "DUSKHAVEN" or sightingData.faction == "DUSKHAVEN")) then
